...
void sensory_embedding_v(std::deque<double>& chassis_angvel, std::deque<double>& chassis_accel, std::deque<double>& left_wheelTorque, std::deque<double> &right_wheelTorque);
void AI_Setup();
void AI_Update();